...
<div align="center">
  <img src="./images/cursor_git_collaboration.png" width="85%" alt="为什么 Git 是 AI 编程必修课">
</div>
...
<div align="center">
  <img src="./images/git_github_relationship.png" width="80%" alt="Git 与 GitHub 的关系">
</div>
...
<div align="center">
  <img src="./images/git_setup_flow.png" width="90%" alt="Git 在 Cursor 工作流中的完整教学路径">
</div>
...
<div align="center">
  <img src="./images/cursor_github_config.png" width="90%" alt="Git 初始化配置与 Cursor 集成验证">
</div>
...
| [Intro-04](./导学4：Claude%20Code部署配置教程.html) | Claude Code | Claude Code 本地部署与配置教程，合并 Cursor 插件使用 |
...
完成环境配置后，进入 **[阶段一：AI编程范式与快速上手](../Stage1_AI_Programming_Fundamentals/)** 开始正式学习 Vibe Coding！
